    ...
    <div className="particle-stage" aria-hidden="true">
      ...
      {particles.map((particle) => (
        <motion.span
          ...
          animate={{ y: [0, -14, 0], opacity: [0.28, 0.8, 0.28] }}
          transition={{
  ...
  return (
    <div className="page-stack reference-structured-page">
      <motion.section className="intro-section" id="intro" initial="initial" animate="animate">
        <motion.div
          ...
          variants={{
            ...
            animate: { opacity: 1, y: 0, scale: 1, transition: { duration: 0.82, ease: [0.22, 1, 0.36, 1] } },
          }}
        >
          <ParticleStage />
        </motion.div>
        ...
        <motion.div
          ...
          variants={{
            initial: { opacity: 0, y: 24 },
            animate: { opacity: 1, y: 0, transition: { duration: 0.78, delay: 0.05, ease: [0.22, 1, 0.36, 1] } },
          }}
        >
      ...
      <motion.section className="about-section section-frame" id="about" {...fadeUp}>
        ...
        <div className="about-grid simple-two-column">
          ...
          <div className="about-aside simple-aside-text">
      ...
      <motion.section className="experience-section section-frame" id="experience" {...fadeUp}>
        ...
        <div className="experience-stack simple-stack">
      ...
      <motion.section className="projects-section section-frame" id="projects" {...fadeUp}>
        ...
        <div className="spotlight-projects simple-project-list">
        ...
        <div className="repo-grid compact-repo-grid simple-repo-grid">
          {repositories.map((repo, index) => (
            <motion.a
              ...
              target="_blank"
              rel="noreferrer"
              className="repo-card simple-repo-item"
      ...
      <motion.section className="contact-section section-frame" id="contact" {...fadeUp}>
        <div className="contact-card simple-contact">
          <div>
